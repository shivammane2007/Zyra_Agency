    ...
    <section id="cta" className="py-32">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="overflow-hidden rounded-[2rem] border border-zyra-border-subtle bg-[radial-gradient(circle_at_top,rgba(57,255,135,0.14),transparent_45%),linear-gradient(160deg,#151515_0%,#090909_100%)] p-10 text-center sm:p-16"
        >
